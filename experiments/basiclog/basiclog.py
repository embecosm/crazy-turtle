...
#            self._lg_stab.start()
#        else:
#            print("Could not add stablizer logconfig since some variables are not in TOC")
        ...
        if self._lg_baro.valid:
            ...
            print("Could not add baro logconfig since some variables are not in TOC")
    ...
    def _stab_log_error(self, logconf, msg):
        """Callback from the stabilizer log API when an error occurs"""
        print "Error when logging stabilizer %s: %s" % (logconf.name, msg)

    def _stab_log_data(self, timestamp, data, logconf):
        """Callback from the stablizer log API when data arrives"""
    ...
    def _baro_log_data(self, timestamp, data, logconf):
        """Callback froma the baro log API when data arrives"""
        print "[%d][%s]: %s" % (timestamp, logconf.name, data)
